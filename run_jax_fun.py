...
from jax_fun import H_free, all_hop, logpsi, make_psi0, make_psi0_ratio, count_double_occ, \
...
def test_anti_ferro_init():
    batch = 5
    Lsite = 6
    N = 3 
    states_init = anti_ferro_init(batch, Lsite, N)
    print(states_init)
...
def test_make_psi0_ratio_vmapped():
    ...
    states_ratio = make_psi0_ratio_vmapped(states, state0, psi) 
...
def test_optimize_g():
    ...
    optimize_g(psi, states_init, Lsite, t, U, nthermal, npoints, nacc, opt_nstep, learning_rate)
